...
from config import USER, NAME, PORT, PASS, HOST
from operations.models import metadata as metadata_operations
...
config.set_section_option(section, "PASS", PASS)
config.set_section_option(section, "NAME", NAME)
